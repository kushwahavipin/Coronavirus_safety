package com.theVipin.musicplayer.Equalizer;
...
import com.theVipin.musicplayer.Database.DataBaseHelper;
...
public class EqualizerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mVolumeHigh.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Fade in volume here.
            }
        ...
        mLoadPresetButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        mSavePreset.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog dialog = EqualizerActivity.this.buildSavePresetDialog();
