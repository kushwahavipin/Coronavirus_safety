...
import com.theVipin.musicplayer.TagEditor.Id3TagEditorActivity;
        ...
        public ItemHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mId3TagEditorActivity.updateAlbumArt(
                            mBestMatchesModels.get(ItemHolder.this.getAdapterPosition()).artworkUrl100.replace("100x100", "500x500")
