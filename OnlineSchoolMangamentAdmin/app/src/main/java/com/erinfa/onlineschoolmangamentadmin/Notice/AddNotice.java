package com.erinfa.onlineschoolmangamentadmin.Notice;
        ...
        uploadTask.addOnCompleteListener(AddNotice.this, new OnCompleteListener<UploadTask.TaskSnapshot>() {
            ...
            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                if (task.isSuccessful()){
                    ...
                    pd.dismiss();
                    Toast.makeText(AddNotice.this,"Somethings went wrong",Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    ...
    private void uploadData() {
        ...
        dbRef.child(uniqueKey).setValue(noticeData).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                pd.dismiss();
                Toast.makeText(AddNotice.this,"Notice Upload Success ",Toast.LENGTH_LONG).show();
