...
public class AddGallery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addGalleryImage.setOnClickListener(view -> openGallery());

        uploadGalleryBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (bitmap==null){
                    Toast.makeText(AddGallery.this,"Please Upload Image",Toast.LENGTH_LONG).show();

                }else if (category.equals("Select Category")){
                    Toast.makeText(AddGallery.this,"Please Select  Image Category ",Toast.LENGTH_LONG).show();
                }else {
        ...
        uploadTask.addOnCompleteListener(AddGallery.this, new OnCompleteListener<UploadTask.TaskSnapshot>() {
            ...
            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                if (task.isSuccessful()){
                    ...
                    pd.dismiss();
                    Toast.makeText(AddGallery.this,"Somethings went wrong",Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    ...
    private void uploadData() {
        ...
        reference.child(uniqueKey).setValue(downloadUrl).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onFailure(@NonNull Exception e) {
                pd.dismiss();
           Toast.makeText(AddGallery.this,"Somethings went wrong",Toast.LENGTH_SHORT).show();
            }
        });
    }
